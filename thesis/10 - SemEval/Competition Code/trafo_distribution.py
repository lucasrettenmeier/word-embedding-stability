...
for language in languages:
	for model in models:
		...
		trafo_displacement = get_cosine_similarity(m1, t.apply_to(m2), word_indices = eval_indices)

		results[model] = trafo_displacement

	# Save Results and Word List
	dist_folder = exp_folder + 'trafo_distributions/' + language +'/'	
